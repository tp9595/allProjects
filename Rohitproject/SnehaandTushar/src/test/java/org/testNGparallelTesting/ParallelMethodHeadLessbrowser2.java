...
public class ParallelMethodHeadLessbrowser2 {
	...
	public void createUser() {
		System.out.println("Headlesss 1 : "+Thread.currentThread().getId());
		System.out.println("createUser");
//		bu.waitForVisibilityofElement(driver, 30, By.id("container_users"));
...
//	}
	...
	public void createCusomer() throws EncryptedDocumentException, IOException, InterruptedException {
		System.out.println("Headlesss 2 : "+Thread.currentThread().getId());
		System.out.println("createCusomer");
//		bu.waitForVisibilityofElement(driver, 20, By.cssSelector("#container_tasks"));
...
//		}
	...
	public void deleteCustomer() throws InterruptedException {
		System.out.println("Headlesss 3 : "+Thread.currentThread().getId());
