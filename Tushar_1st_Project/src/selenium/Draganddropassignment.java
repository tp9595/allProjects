...
public class Draganddropassignment {
	...
	void clickondrag(WebDriver driver)
	{
		WebElement frame =driver.findElement(By.xpath("//*[contains(@class,'demo-frame')]"));
		driver.switchTo().frame(frame);
		WebElement drag = driver.findElement(By.xpath("//*[contains(@class,'ui-widget-content ui-selectee ui-selected')]"));
	...
	public static void main(String[] args) {
		...
		System.setProperty("webdriver.chrome.driver","C:/Users/akshay/Downloads/CHROME/chromedriver.exe");
		   // System.setProperty("webdriver.chrome.driver", "D:/java software/chromedriver.exe");
			...
			Draganddropassignment obj = new Draganddropassignment();
			obj.firstmethodone(driver);
			obj.clickondrag(driver);
